...
中图分类号：R917 文献标识码：A 文章编号：0254-1793(2007)06-0821-04
...
2.1 色谱条件 色谱柱: $\text{Diamonsil}^{\text{TM}}(\text{钻石})\text{C}_{18}(200\ \text{mm} \times 4.6\ \text{mm}, 5\ \mu\text{m})$ ; 流动相: 乙腈 - 0.01 mol·L $^{-1}$ 磷酸二氢钾缓冲液 (pH 5.0) (58:42),; 进样量 20 μL; 流速: 1.0 mL·min $^{-1}$ ; 检测波长: 220 nm, 柱温: 30 ℃。  
...
学院动物房提供(从中科院上海实验动物中心引进)。SD大鼠分为雌雄2批,每批3组,每组5只。其中3组分别为:佐米曲坦灌胃处理3d组(雄性25.0 mg·kg $^{-1}$ 和雌性50.0 mg·kg $^{-1}$ );地塞米松100 mg·kg $^{-1}$ 灌胃处理3d组;空白组生理盐水灌胃处理。
...
3.1 方法专属性考察 咪达唑仑在流动相中色谱峰形对称, 柱效高, 内标与咪达唑仑之间有很好的分离度, 且保留时间适中, 上述色谱条件下测得 $2.71 \mu g \cdot mL^{-1}$ 咪达唑仑对照品血浆的色谱图见图 1。

![](images/b2a433a27b466cf3fc9b030aed81b69b29708e582862fee7affdace2d802103c.jpg)
...
![](images/ef5c2b3682825463f057c735cd6da09c76833b02a92bdb0f24d09beb759a2c4f.jpg)
...
3.2 线性范围和灵敏度 取不同浓度的咪达唑仑对照品溶液,加到空白大鼠血浆中,使咪达唑仑的最终浓度分别为0.11,0.27,0.54,2.71,10.86,27.15,54.30,135.75 $\mu g\cdot mL^{-1}$ 。以咪达唑仑的浓度X为横坐标，咪达唑仑与内标物峰面积比值Y为纵坐标，进行线性回归，回归方程为：

$$
Y = 0. 0 4 1 X + 0. 0 0 2 1 \quad r = 0. 9 9 9 7 (n = 5)
$$

咪达唑仑在 $0.11 \sim 135.75 \mu g \cdot mL^{-1}$ 浓度范围内与峰面积呈良好的线性关系。检测限为 $0.0018 \mu mol \cdot L^{-1} (S/N = 3)$ ，定量限为 $0.072 \mu mol \cdot L^{-1} (RSD < 5\%, n = 5)$ 。
...
![](images/0380a40b9a83dd1b1fc89d1867fdad4cfc6be0523d47ab7c8f95fb3f84736bda.jpg)
...
![](images/eda562e890b9aaa5db4a741e9d6e0eb884e7b4c760b736b5733f4683df68e3a8.jpg)
...
Fig 2 Plasma concentration $(\bar{x} \pm SD)$ of midazolam after $10\mathrm{mg} \cdot \mathrm{kg}^{-1}$ intravenous dose following pretreatment with $100\mathrm{mg} \cdot \mathrm{kg}^{-1}$ dexamethasone or $25\mathrm{mg} \cdot \mathrm{kg}^{-1}$ zolmitriptan once daily for 3 days in SD-rats  
